...
BG.Init(function()
    ...
    local function CreateMainFrame()
        ...
        do
            ...
            do
                ...
                tex:SetSize(16, 16)
                tex:SetTexture(ns.MediaIcon and ns.MediaIcon.logo or "Interface\\Icons\\INV_Misc_Book_09")
        ...
        function rightFrame.UpdateEnchant(bt, link, skill)
            ...
            if chant then
                if BG.enchant and BG.enchant[chant] then
    ...
    function BG.ShowEquipFrame(click, bt, isAccounts, realmID, player,
        ...
        if not mainFrame or not mainFrame.tipText then
            if mainFrame then
                mainFrame:Hide()
                mainFrame = nil
                leftFrame = nil
